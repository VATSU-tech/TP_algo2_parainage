export default function UserCard() {
  return (
    <div className="flex flex-wrap  w-full gap-4 bg-gray-500 p-4  border-gray-500 rounded-2xl" >
      <div className="hover-3d ">
        ...
        <div className="flex flex-1 min-w-3xs flex-col p-6 justify-around bg-gray-200 rounded-2xl">
            ...
            <p className="text-xl text-gray-500"><i className="fa-solid fa-globe"></i> U.S.A</p> 
        </div>
