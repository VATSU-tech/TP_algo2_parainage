...
import Input from "../components/_input"; // Champ de saisie réutilisable.
...
- Page de connexion simple avec deux champs et un bouton.
- Utilise les composants Input et Button1 pour uniformiser le style.
*/
