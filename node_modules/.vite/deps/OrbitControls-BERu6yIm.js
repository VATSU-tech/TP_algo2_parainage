import { Bo as TOUCH, Ha as Ray, Hi as Plane, Rr as MOUSE, Vr as MathUtils, an as EventDispatcher, bo as Spherical, hs as Vector3, ms as Vector2, na as Quaternion } from "./three.module-DdQAuIlO.js";
...
var OrbitControls = class extends EventDispatcher {
	constructor(object, domElement) {
		...
		this.listenToKeyEvents = function(domElement$1) {
			domElement$1.addEventListener("keydown", onKeyDown);
			this._domElementKeyEvents = domElement$1;
		};
		...
		const panLeft = function() {
			const v = new Vector3();
			return function panLeft$1(distance, objectMatrix) {
		...
		const panUp = function() {
			const v = new Vector3();
			return function panUp$1(distance, objectMatrix) {
		...
		const pan = function() {
			const offset = new Vector3();
			return function pan$1(deltaX, deltaY) {
...
//# sourceMappingURL=OrbitControls-BERu6yIm.js.map